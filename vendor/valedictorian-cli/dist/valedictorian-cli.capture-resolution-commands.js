...
import { captureResolutionListInputSchema, completeCaptureManuallyInputSchema, replayCaptureRevisionInputSchema, retryCaptureProcessingInputSchema, } from '@sparxie/sdk';
...
export function buildCaptureResolutionRoute() {
    return buildRouteMap({
        ...
        routes: {
            ...
            replay: identifiedMutation('Replay an unpromoted capture revision', replayCaptureRevisionInputSchema, (client, input) => client.captureResolution.replay(input)),
            complete: identifiedMutation('Atomically complete a capture into a job', completeCaptureManuallyInputSchema, (client, input) => client.captureResolution.complete(input)),
        },
    });
}
