import { booleanFlags, makeCommand, optionFlags, optionValue, parseTimeoutMs, readPackageVersion, writeJson, } from './valedictorian-cli.command-runtime.js';
...
export function buildContextCommand() {
    return makeCommand({
        ...
        run: async (context, flags) => {
            writeJson(context, await runContext({
                cwd: context.cwd,
                env: context.env,
