import { upsertConnectorScheduleInputSchema, } from '@sparxie/sdk';
import { assertKnownOptions, parseStrictJsonValue, readRequiredOption, } from './valedictorian-cli.parser-options.js';
export function parseConnectorScheduleUpsert(connectorInstanceId, argv) {
