...
import { createHttpValedictorianClient, defaultValedictorianApiBaseUrl, } from '@sparxie/sdk';
...
import { definedEnv, normalizeArgv, readArgvEscapeSuffix, readPackageVersion, } from './valedictorian-cli.command-runtime.js';
import { buildContextCommand, buildDoctorCommand, } from './valedictorian-cli.diagnostics-commands.js';
import { argvRequestsJson, CliUsageError, isStricliUsageExitCode, mapStricliExitCode, presentCliFailure, } from './valedictorian-cli.failures.js';
...
export async function runValedictorianCli({ argv, cwd = process.cwd(), env = process.env, stdout = (value) => process.stdout.write(value), stderr = (value) => process.stderr.write(value), secretsRunSpawn, }) {
...
const application = buildApplication(buildRouteMap({
...
async function runValedictorianApp(argv, context) {
