...
export const slowTestBoundaryInventory: readonly SlowTestDuration[] = [
  ...
  { path: 'src/modules/connectors/connector.repository.retry-ledger.test.ts', hostedDurationMs: 50926 },
  ...
  { path: 'src/modules/connectors/connector.runner.refresh-contract.test.ts', hostedDurationMs: 32529 },
  ...
  { path: 'src/modules/connectors/connector-schedule.repository.pglite.test.ts', hostedDurationMs: 18441 },
  { path: 'src/modules/connectors/connector.repository.test.ts', hostedDurationMs: 18389 },
  ...
  { path: 'src/modules/connectors/connector.repository.bounded-history.test.ts', hostedDurationMs: 14700 },
  { path: 'src/runtime/local-valedictorian-client.connector-settings-edge.test.ts', hostedDurationMs: 14490 },
  { path: 'src/modules/connectors/connector.runner.auth-catchup.test.ts', hostedDurationMs: 13803 },
  ...
  { path: 'src/modules/connectors/connector.runner.budgets-validate-auth.test.ts', hostedDurationMs: 11025 },
