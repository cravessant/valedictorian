...
import { connectorCaptureWork, connectorRuns } from '@sparxie/valedictorian-local-runtime/testing/modules/connectors/adapters/persistence/connector.schema'
import { sourceExecutionScopes } from '@sparxie/valedictorian-local-runtime/testing/db/schema'
import type { PgliteClient, PgliteDatabase } from '@sparxie/valedictorian-local-runtime/database'
