...
import { applications as applicationRows, pursuitLinks, applicationEventRecords, applicationHistory } from '@sparxie/valedictorian-local-runtime/testing/modules/application/application.schema'
import { captures as captureRows } from '@sparxie/valedictorian-local-runtime/testing/modules/capture/capture.schema'
import { jobs as jobRows } from '@sparxie/valedictorian-local-runtime/testing/modules/job/job.schema'
import { opportunities as opportunityRows } from '@sparxie/valedictorian-local-runtime/testing/modules/opportunity/opportunity.schema'
