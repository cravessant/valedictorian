...
Read this when constructing strict `--input-json` for a lifecycle promotion. These examples match the `@sparxie/sdk@0.36.0` surface. Replace values from inspected records; never invent facts, revisions, identities, or evaluation.
