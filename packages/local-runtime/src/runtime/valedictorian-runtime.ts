...
import type { LocalWorkspaceClient } from './local-connector-client.contract.js'
import type { LocalWorkspaceManager } from '../server/local-workspaces.js'
import {
  defaultInitialWorkspaceSettings,
  type LocalRuntimeSettings,
} from './runtime-settings.js'
import { isSecretCodecAvailable, type SecretCodec } from '../modules/secrets/public.js'
import {
  prepareWorkspaceProfileCapabilities,
  type PreparedWorkspaceProfileCapabilities,
} from '../modules/profile/public.js'
import {
  createLocalValedictorianClient,
  type LocalValedictorianClient,
  type ValedictorianSeedDataMode,
  type LocalValedictorianClientOptions,
} from './local-valedictorian-client.js'
import {
...
import type { SecretService } from '../modules/secrets/public.js'
...
export function resolveValedictorianRuntimeConfig({
  apiToken,
  env = process.env,
  settings = defaultInitialWorkspaceSettings,
  userDataPath,
  workspaceDataPath,
  workspaceId,
