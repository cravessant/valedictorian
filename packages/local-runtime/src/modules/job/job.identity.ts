...
import { jobExternalIdentityKinds, jobIdentityStrengths } from '../../db/lifecycle-vocabulary.js'
import { jobCaptureEvidenceReferences, jobExternalIdentities, jobHistory, jobs } from './job.schema.js'
import {
