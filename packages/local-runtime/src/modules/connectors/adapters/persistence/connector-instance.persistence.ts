...
import { assertPersistedEarliestBackfillDate, defaultEarliestBackfillDate } from '../../public/connector.earliest-backfill.js'
import type { ConnectorAuthMode, ConnectorAuthReference, ConnectorInstanceRecord, UpsertConnectorInstanceInput } from '../../ports/connector-instance.records.js'
import { optionalNonEmptyString, requiredNonEmptyString, toJsonRecord } from '../../ports/connector.json-values.js'
import { deriveSourceExecutionScopeId } from '../../../source-execution/source-execution-governor.js'
import { ensureSourceExecutionScope } from '../../../source-execution/source-execution.persistence.js'
import { JOBRIGHT_CONNECTOR_ID } from '../../public/jobright.constants.js'
