import { connectorObservations } from '../../../../db/schema.js'
import type { ConnectorObservationEvidence, ConnectorObservationLinks, ConnectorObservationRecord, ConnectorObservationResolution } from '../../ports/connector-observation.records.js'
import type { JsonRecord } from '../../ports/connector.json-values.js'
