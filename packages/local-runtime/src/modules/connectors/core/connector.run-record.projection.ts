...
import type { ConnectorRunOccurrenceReader } from '../ports/connector-schedule.repository.port.js'
import type { LocalConnectorRunSummary } from './connector.consumer-contract.js'
import { mapConnectorWarnings } from '../public/connector.status-view.js'
import { publicConnectorRunLifecycleCounts } from '../public/connector.run-projection.js'
...
export function createConnectorRunSummaryProjection({
  ...
  scheduleRepository: ConnectorRunOccurrenceReader
}) {
