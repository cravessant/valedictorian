...
import type { AppJobConnector } from '../ports/connector.runner-contracts.js'
import {
  ConnectorAdmissionError,
  admitInstalledConnectorDescriptor,
} from './connector.installed-descriptor.js'

export { ConnectorAdmissionError } from './connector.installed-descriptor.js'
