...
import type { ConnectorSourceExecutionGovernor } from '../ports/connector.source-execution.port.js'
import type { AppConnectorAuthValidationResult } from '../ports/connector.runner-contracts.js'

export async function finalizeReconnectValidation(input: {
  governor?: ConnectorSourceExecutionGovernor
