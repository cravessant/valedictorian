...
import { captureEvidenceModes, captureSourceAdapterKinds } from '../../db/lifecycle-vocabulary.js'
import { LIFECYCLE_ID_MAX as WORKSPACE_MAX, type AdmittedCommandActor, type BoundedJson, type LifecycleActorInput, type LifecycleActorType, actorAuditJson as auditJson, admitBoundedJson, admitCommandActor, admitLifecycleId, isUniqueViolation, owning, safeParseJson } from '../lifecycle/lifecycle-representation.js'
import {
...
export type { JsonValue } from '../lifecycle/lifecycle-representation.js'
import type { JsonValue } from '../lifecycle/lifecycle-representation.js'
