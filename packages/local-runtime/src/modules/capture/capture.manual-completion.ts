...
import {
  ...
  updateCompanyHead,
  type CompanyTx,
} from '../company/company.command-support.js'
import { assignInitialCompanyOn } from '../company/company.assignment.service.js'
import { createInlineCompanyOn } from '../company/company.commands.js'
import {
  jobCompanyAssignments,
  workspaceCompanies,
} from '../company/company.schema.js'
import {
...
import type { JobIdentityService } from '../job/job.identity.js'
import type { JobService } from '../job/job.service.js'
import { requireActor } from '../job/job.validation.js'
import type { JobPromotionService } from '../lifecycle/capture-to-job.promotion.js'
