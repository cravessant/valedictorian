...
import { insertJobCaptureEvidenceReferences } from '../job/job.repository.js'
import type { CaptureEvidenceInput, CaptureService } from '../capture/capture.service.js'
import type { JobService } from '../job/job.service.js'
import type { OpportunityRecord, OpportunityService, OpportunityWarningCode } from '../opportunity/opportunity.service.js'
import type {
  AddLinkInput,
  ...
  JsonValue,
} from '../applications/application.aggregate.service.js'
import {
...
} from '../applications/application.aggregate.validation.js'
