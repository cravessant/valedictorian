...
import { captures } from '../capture/capture.schema.js'
import { jobCaptureEvidenceReferences, jobs } from '../job/job.schema.js'
import { opportunities } from '../opportunity/opportunity.schema.js'
import { applicationAttemptRecords, applicationEventRecords, applications, pursuitLinks } from '../application/application.schema.js'
import { deleteJobCaptureEvidenceReferences } from '../job/job.repository.js'
...
import type { ApplicationAggregateService, ApplicationDeleteExec } from '../applications/application.aggregate.service.js'
